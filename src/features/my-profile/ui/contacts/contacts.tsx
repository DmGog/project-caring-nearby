    ...
    return (
        <Box paddingTop={"30px"}>
            ...
            <List>
                ...
                <ListItem sx={{gap:"32px"}} dense disableGutters><TelegramIcon/>{data.contacts.social.telegram}</ListItem>
                <ListItem sx={{gap:"32px"}} dense disableGutters><WhatsappIcon/>{data.contacts.social.whatsapp}</ListItem>
            </List>
